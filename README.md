The nomenclature script try to find the nomenclature of a given molecule (doesn't work very well; in fact, it works for only some given examples).
...
You need to install kandinsky and ion ("pip install kandinsky" and "pip install ion-Numworks"). It's because it's normally for the Numwokrs calculator.
